...
public class Ex5_WindowAggregation {
    ...
    public static void main(String args[]){
        ...
        String epl = "select count(*) as Total, sum(age) as Ages from PersonEvent#length(5)";
        ...
        statement.addListener( (newData, oldData) -> {
            ...
            System.out.println(String.format("Total: %d, AvgAge of last %d: %d", total, total, ages/total));
        });
